...
class _BasicInformationState extends State<BasicInformation> {
  ...
  void getData() async {
//Fetching of Data
    final SharedPreferences _data = await _prefs;
    setState(() {
      nameController.text = _data.getString('fullName').toString();
      birthController.text = _data.getString('dob').toString();
      bioController.text = _data.getString("bio").toString();
      genderController.text = _data.getString("gender").toString();
      idController.text = _data.getString("governmentId").toString();
    });
  }
